  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[var(--color-obsidian)]/60 backdrop-blur-xl border-b border-[var(--color-border-subtle)]">
      <div className="max-w-[1400px] mx-auto px-6 h-20 flex items-center justify-between">
        ...
        {/* Navigation links */}
        <nav className="hidden md:flex items-center gap-8 text-[12px] tracking-[0.15em] uppercase font-medium text-[var(--color-slate-muted)]">
        ...
        <div className="flex items-center gap-5">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-2.5 bg-transparent border border-[var(--color-amber-gold)] text-[var(--color-amber-gold)] text-[11px] font-semibold uppercase tracking-widest hover:bg-[var(--color-amber-gold)] hover:text-[var(--color-obsidian)] transition-all active:scale-95"
          >
